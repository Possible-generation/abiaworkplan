...
//             <div><strong>Week:</strong> ${selectedWeekLabel} of ${selectedMonthLabel}</div>
//           </div>
...
//                   <td>${task.tools || task.tool || "Not specified"}</td>
...
//                   setIsMonthOpen(false);
//                 }}
//                 className="flex items-center justify-between w-40 px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
//                 disabled={loading}
//               >
...
//               className="px-4 py-2 rounded-md border border-gray-400 text-sm text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
//             >
//               Export Work Plan
//             </button>
//             <button
...
//                   setIsSortOpen(false);
//                 }}
//                 className="flex items-center justify-between w-32 px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
//                 disabled={loading}
//               >
...
//                           className="text-green-600 hover:text-green-900 hover:bg-green-50 px-2 py-1 rounded inline-flex items-center"
//                         >
