        ...
        <div className="mt-6 bg-white p-4 md:flex grid place-content-center md:justify-between gap-6 items-center">
          ...
          <div className="mt-6 md:mt-0 flex space-x-2">
            <button
              ...
              className={`px-4 py-2 cursor-pointer rounded-md text-sm flex justify-center items-center ${
            ...
            <button
              ...
              className="px-2 py-2 bg-flag-green text-white cursor-pointer rounded-md text-sm hover:bg-flag-green"
            >
              Review Performance
            </button>
          </div>
