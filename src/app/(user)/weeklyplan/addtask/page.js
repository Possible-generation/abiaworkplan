// orginal form data with api implemetTION SUCCESSFUL
...
// import useWorkplanStore from "../../../../store/workplanStore"; // Fixed import'
...
//   const { createWorkplan, loading } = useWorkplanStore(); // Fixed store usage
...
//         notes: "",
//         tools: "",
//         priority: "medium", // Fixed default value
//         time: "08:00",
//         status: "pending", // Fixed default value
//         constraints: "",
//       },
//     ])
//   );

//   // Handle task input changes - Fixed to handle both field name and event object
//   const handleTaskChange = (dayIndex, taskIndex, fieldOrEvent, value) => {
//     const updated = [...tasksByDay];

//     if (typeof fieldOrEvent === "string") {
//       // Direct field update
//       updated[dayIndex][taskIndex][fieldOrEvent] = value;
//     } else {
//       // Event object
//       const { name, value: eventValue } = fieldOrEvent.target;
//       updated[dayIndex][taskIndex][name] = eventValue;
//     }
...
//     const updated = [...tasksByDay];
//     updated[dayIndex].splice(taskIndex, 1);
//     setTasksByDay(updated);
//   };
...
//     try {
//       // Build plans array with all days that have tasks
//       const plans = [];

//       DAYS.forEach((dayName, dayIndex) => {
//         const dayTasks =
//           tasksByDay[dayIndex]?.filter((task) => task.title.trim() !== "") ||
//           [];

//         if (dayTasks.length > 0) {
//           plans.push({
//             day: dayName.toUpperCase(), // e.g. "MONDAY"
//             task: dayTasks.map((task) => ({
//               title: task.title,
//               notes: task.notes || "",
//               tools: task.tools || "",
//               priority: task.priority.toUpperCase(), // "HIGH", "MEDIUM", "LOW"
//               time: task.time,
//               status: task.status.toUpperCase(), // "PENDING", "IN_PROGRESS", "COMPLETED"
...
//     return currentDayTasks.some((task) => task.title.trim() !== "");
//   };
...
//     tasksByDay[currentDay]?.filter((task) => task.title.trim() !== "") || [];
//   const modalCurrentDayName = DAYS[modalCurrentDay];
//   const modalCurrentDayTasks =
//     tasksByDay[modalCurrentDay]?.filter((task) => task.title.trim() !== "") ||
//     [];
...
//             {/* Task Form */}
//             {tasksByDay[currentDay].map((task, taskIndex) => (
//               <div
//                 key={task.id}
//                 className="space-y-4 mb-6 p-4 border border-gray-200 rounded-lg"
//               >
//                 <div className="flex justify-between items-center">
//                   <h3 className="text-md font-medium text-gray-700">
//                     Task {taskIndex + 1}
//                   </h3>
//                   {tasksByDay[currentDay].length > 1 && (
//                     <button
//                       onClick={() => removeTask(currentDay, taskIndex)}
...
//                     name="title"
//                     value={task.title}
//                     onChange={(e) => handleTaskChange(currentDay, taskIndex, e)}
...
//                       value={task.tools}
//                       onChange={(e) =>
//                         handleTaskChange(currentDay, taskIndex, e)
//                       }
//                       className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-flag-green"
...
//               className="w-full bg-flag-green text-white py-2 px-4 rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-flag-green mb-6"
//             >
//               Add Another Task
//             </button>
...
//                   disabled={loading}
//                   className="px-6 py-2 bg-flag-green text-white rounded-md hover:bg-green-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
//                 >
...
//           <div className="bg-white rounded-lg p-6 max-w-sm mx-auto grid place-items-center">
...
//                 }}
//                 className="px-6 py-2 bg-flag-green text-white rounded-md hover:bg-green-700"
//               >
//                 Download workplan
//               </button>
//             </div>
