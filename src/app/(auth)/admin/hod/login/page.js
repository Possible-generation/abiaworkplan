...
export default function Login() {
  ...
  const { loginUser } = usehodAuthStore();
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (result?.status) {
          ...
          router.push("/admin/hodd/dashboard");
        } else {
          ...
          >
            <div>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full mt-3 p-2 flex justify-center items-center gap-2 text-white rounded-md transition-colors duration-200 ${
                  loading
              ...
              <div className="mt-4 text-[14px] text-center">
                <p>
                  ...
                  <a href="/admin/hod/register" className="text-flag-green">
                    Register
                  </a>
                </p>
              </div>
