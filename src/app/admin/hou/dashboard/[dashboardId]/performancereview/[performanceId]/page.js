...
//   // Get URL parameters
//   const staffId = searchParams.get("staffId") || "8"; // fallback to default
...
//               Export Work Plan
//             </button>
//             <button className="px-4 py-2 bg-flag-green text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-flag-green flex items-center justify-center">
//               Approve Plan
//             </button>
//           </div>
//         </div>
...
//                       <td className="border-b border-gray-300 px-4 py-3   text-gray-900 font-medium align-top">
