...
import useReportStore from "../../../../../store/admin/hos/reportStore";
...
export default function ReviewTasksPage() {
  ...
  const handleSubmitReview = async () => {
    ...
    router.push("/admin/hos/weeklyreport");
  };
                    ...
                    {completionStatus[task.id] ? (
                      ...
                      <div className="flex space-x-3">
                        ...
                        <button
                          ...
                          className="px-4 py-2 text-gray-800 rounded-md border border-gray-300 hover:bg-flag-green hover:text-white "
                        >
                          No
                        </button>
                      </div>
        ...
        {allDaysReviewed && (
          <div className="mt-6 p-6 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex-col items-center justify-between">
              ...
              <button
                onClick={() => router.push("/admin/hos/weeklyreport")}
