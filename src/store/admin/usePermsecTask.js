...
const usePermsecTask = create(
  persist(
    (set, get) => ({
      ...
      fetchStaffTasks: async (staffId, departmentId, unitId, month, week) => {
        ...
        try {
          ...
          if (res.data.success) {
            ...
            set({
              ...
              tasks: allTasks,
              loading: false,
              lastFetchParams: { staffId, departmentId, unitId, month, week }, // Store successful params
            });
            ...
            console.log("Fetched data:", {
              ...
              plans: transformedPlans,
              tasks: allTasks,
              params: { staffId, departmentId, unitId, month, week },
            });
          } else {
            ...
            set({
              ...
              loading: false,
              lastFetchParams: { staffId, departmentId, unitId, month, week }, // Still track the params
            });
          }
        } catch (err) {
          ...
          set({
            ...
            loading: false,
            lastFetchParams: { staffId, departmentId, unitId, month, week }, // Track failed attempt too
          });
        }
      },

      // Check if data exists for current parameters
      hasDataForParams: (staffId, departmentId, unitId, month, week) => {
        const { lastFetchParams, tasks } = get();
        return (
          lastFetchParams &&
          lastFetchParams.staffId === staffId &&
          lastFetchParams.departmentId === departmentId &&
          lastFetchParams.unitId === unitId &&
