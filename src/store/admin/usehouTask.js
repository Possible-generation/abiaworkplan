...
//   fetchStaffTasks: async (staffId, month, week) => {
//     set({ loading: true, error: null });
//     try {
//       const res = await axiosInstance.post(`/api/hou/dashboard/staff`, {
//         staff_id: staffId,
//         month: month,
//         week: week,
...
//         const transformedPlans = transformPlans(staff.plans);
//         const allTasks = transformedPlans.flatMap((p) => p.tasks);
